...
Создал отдельный диск, подключил, создал раздел. примонтировал /mnt/mytmpfs

root@slim-dev:/sbin# df -h
...
/dev/sdb        976M  2.6M  907M   1% /mnt/mytmpfs